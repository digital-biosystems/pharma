...
Your patient3 is treated using a drug Lithium Carbonate. 
...
2. estimate clearance until C touch lab value <bdl-range2 id="clearance" title="clearance [l/h]" min="2" max="20" default="9.4" step="0.1" initdefault="true"></bdl-range2>
