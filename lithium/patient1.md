...
Your patient 1 is treated using a drug Lithium Carbonate. 
...
<bdl-buttonparams title="500mg" ids="adminmass" values="500" ></bdl-buttonparams> 

<bdl-buttonparams title="800mg" ids="adminmass" values="800"></bdl-buttonparams> 

<bdl-buttonparams title="1500mg" ids="adminmass" values="1500"></bdl-buttonparams> 

<bdl-buttonparams title="2000mg" ids="adminmass" values="2000"></bdl-buttonparams> 
...
2. estimate clearance until C touch lab value <bdl-range2 id="clearance" title="clearance [l/h]" min="2" max="20" default="3.4" step="0.1" initdefault="true"></bdl-range2>
...
<bdl-range2 id="vd" title="volume of distribution [l/kg]" min="1" max="5" default="4.6" step="0.1" initdefault="true"></bdl-range2>
