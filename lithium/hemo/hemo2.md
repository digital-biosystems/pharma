...
<div class="w3-col l4 m4 s4">
 You have patient with a cardiac condition (systolic heart failure). Cardiologists use PV diagrams to visualize and quantify the full cardiac cycle in a pressure-volume relationship that guides understanding of pathophysiology and response to therapy. The therapeutic goal is to increase stroke work and cardiac output, i.e. increase PV loop (right chart) width.

1. Start simulation
2. Try these two drugs

<bdl-buttonparams title="Digoxin 0.125mg" ids="idlve,id1" values="120,60"></bdl-buttonparams>

<bdl-buttonparams title="Nifedipin 20mg" ids="idlve,id1" values="70,90"></bdl-buttonparams>

3. Which one best match the therapeutic target?
</div>
<div class="w3-col l4 m4 s4">
<table>
<tr><td>
<div style="width:140px;display:inline-grid">
<bdl-animate-adobe src="hemo/Faze_srdce.js" width="300" height="300" name="Faze_srdce" fromid="id5" fmuid="id4" responsive="true"></bdl-animate-adobe>
...
<div class="w3-hide">
Heart rate(1/min): <!--bdl-sound-on-increase thresholdvalue="1e-6" fromid="id4" refindex="7" freq="440" volume="0.05"></bdl-sound-on-increase--> <bdl-range2 id="id1" title="" min="40" max="200" default="80" step="1"></bdl-range2>
Cardiac inotropy(%):<bdl-range2 id="idlve" title="" min="50" max="200" default="100" step="0.1"></bdl-range2>
</div>

<bdl-chartjs-time id="id11" width="300" height="120" fromid="id4" maxdata="128" labels="Left Ventricle Pressure, Aorta Pressure, Pressure in Left Atria" refindex="1" refvalues="3" ylabel="pressure (mmHg)" xlabel="time (s)" convertors="0.00750062,1;0.00750062,1;0.00750062,1" throttle="0" responsive="true"></bdl-chartjs-time>
<bdl-chartjs-time id="id11" width="300" height="120" fromid="id4" maxdata="128" labels="Left Ventricle Volume" refindex="0" refvalues="1" ylabel="volume (ml)" xlabel="time (s)" convertors="1000000,1" throttle="0" responsive="true"></bdl-chartjs-time>
</div>
<div class="w3-col l4 m4 s4">
<bdl-chartjs-xy id="id10" width="300" height="400" fromid="id4" labels="volume,pressure" initialdata="" refindex="0" refvalues="2" maxdata="512" convertors="1000000,1;0.00750062,1" xlabel="volume" ylabel="pressure" responsive="true"></bdl-chartjs-xy>
